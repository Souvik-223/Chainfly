...
const chartData = [
  { browser: "chrome", visitors: 2075, fill: "var(--color-chrome)" },
  { browser: "safari", visitors: 2000, fill: "var(--color-safari)" },
  { browser: "firefox", visitors: 2807, fill: "var(--color-firefox)" },
  { browser: "edge", visitors: 1703, fill: "var(--color-edge)" },
  { browser: "other", visitors: 1090, fill: "var(--color-other)" },
]
